...
insert into review(id, rating, description, created_at, updated_at, course_id) 
	values (5001, '4', 'good course', sysdate(), sysdate(), 1001);
insert into review(id, rating, description, created_at, updated_at, course_id) 
	values (5002, '5', 'ok course', sysdate(), sysdate(), 1001);
insert into review(id, rating, description, created_at, updated_at, course_id) 
	values (5003, '4', 'not okay course',  sysdate(), sysdate(), 1002);
